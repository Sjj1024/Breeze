...
$theme_options = array(
	...
	'文章设置' => array(
		...
		array(
			...
			'id'    => 'git_copyright_b',
			'type'  => 'textarea',
			'std'   => '1024小沈 , 版权所有丨如未注明 , 均为原创丨本网站采用<a href="http://creativecommons.org/licenses/by-nc-sa/3.0/" rel="nofollow" target="_blank" title="BY-NC-SA授权协议">BY-NC-SA</a>协议进行授权 <br >转载请注明原文链接：<a href="{{link}}" target="_blank" title="{{title}}">{{title}}</a>'
		)
	),
	...
	<li><a href="https://gitcafe.net/" title="云落的网站" target="_blank">云落的网站</a></li></ul>'
		...
		array(
			...
			'id'    => 'git_footcode',
			'type'  => 'textarea',
			'std'   => 'Copyright © 2014-2015 <a href="/" title="1024小沈">1024小沈</a> | <a rel="nofollow" target="_blank" href="/about.html">关于网站</a> | <a rel="nofollow" target="_blank" href="/tags.html">标签汇总</a> | <a rel="nofollow" target="_blank" href="/archive.html">文章归档</a> | <a rel="nofollow" target="_blank" href="/links.html">友情链接</a> | <a href="/sitemap.html" target="_blank" title="站点地图（HTML版）">网站地图</a> | 由 <a rel="nofollow" target="_blank" href="https://gitcafe.net/goto/ad">云左</a> &amp; <a rel="nofollow" target="_blank" href="https://gitcafe.net/go/qiniu">七牛</a> &amp; <a href="/wp-admin">强力驱动</a>'
		),
		array(
			'name'  => '全站底部脚本代码',
	...
	'高级设置' => array(
		...
		array(
			...
			'id'    => 'git_mp_tips',
			'type'  => 'textarea',
			'std'   => '请关注1024小沈官方微信公众号，关注并订阅<span style="color:#E96463;font-weight:bold;">云落1024小沈</span>获取验证码。在微信里搜索<span style="color:#E96463;font-weight:bold;">云落1024小沈</span>或者微信扫描二维码都可以关注1024小沈官方微信公众号。'
		),
		array(
			'title' => 'HTML5 桌面推送',
			'type'  => 'title'
		...
		array(
			'name'  => 'HTML5推送链接【可选】',
			'desc'  => '当用户点击弹窗的时候说点击的链接，默认为1024小沈',
		...
		array(
			...
			'type'  => 'textarea',
			'std'   => '1024小沈，一个分享有趣的安卓APP和实用的WordPress技术以及Windows使用技巧的网站'
		),
		array(
			'title' => 'SMTP邮箱设置',
			'type'  => 'title'
