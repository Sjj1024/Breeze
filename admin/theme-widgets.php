...
class git_banner extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('git_banner', 'Breeze-广告', $widget_ops);
    }
...
class git_comment extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_comment', 'Breeze-最新评论', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
...
class git_postlist extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_postlist', 'Breeze-聚合文章', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
...
class git_reader extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_reader', 'Breeze-活跃读者', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
...
class git_rec extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_rec', 'Breeze-推荐模块', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
...
class git_slick extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_slick', 'Breeze-幻灯片(风格二)', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
...
class git_slide extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_slide', 'Breeze-幻灯片(风格一)', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $img1 = $instance['img1'];
...
class git_social extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_social', 'Breeze-社交按钮', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
        ...
        if (git_get_option('git_rss')) echo '<a href="' . git_get_option('git_rss') . '" rel="external nofollow" target="_blank"  title="订阅本站"><i class="rss fa fa-google"></i></a>';
        echo '</div></div></div>';
        echo $after_widget;
    }
    function form($instance) {
...
class git_subscribe extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_subscribe', 'Breeze-邮箱订阅', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
...
class git_tag extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_tag', 'Breeze-标签云', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
...
class git_textbanner extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('git_textbanner', 'Breeze-特别推荐', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
        $title = apply_filters('widget_name', $instance['title']);
...
class git_tongji extends WP_Widget {
    function __construct() {
        ...
        parent::__construct(false, 'Breeze-网站统计', $widget_ops);
    }
    function form($instance) {
