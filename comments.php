...
<div id="respond" class="no_webshot">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<div class="comt-title">
			...
			<?php
				if ( is_user_logged_in() ) {
					printf($user_identity.'<span>发表评论：</span>');
				}else{
					if( get_option('require_name_email') && !empty($comment_author_email) ){
						printf($comment_author.' <span>发表评论：</span> &nbsp; <a class="switch-author" href="javascript:;" data-type="switch-author" style="font-size:12px;">换个身份</a>');
					}else{
						printf('发表评论：');
					}
				}
		...
		<div class="comt">
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					...
					<?php if(!git_get_option('git_qiandao')) echo '<span class="muted comt-sign"><i class="fa fa-pencil-square-o"></i><a href="javascript:SIMPALED.Editor.daka()" style="color:#999999"> 签到</a></span>';?>
				</div>
			</div>
