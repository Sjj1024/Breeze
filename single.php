...
?>
    ...
    echo timeago(get_gmt_from_date(get_the_modified_time('Y-m-d G:i:s'))) ?></span>
...
<div class="article-social">
    ...
    if (isset($_COOKIE['bigfa_ding_' . $post->ID])) echo ' actived'; ?>"><i class="fa fa-thumbs-o-up"></i>点赞 (<span class="count"><?php
